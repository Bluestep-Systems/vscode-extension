...
export default async function (): Promise<void> {
  try {
    ...
    const scriptRoot = App.factory.createFile(B6PUri.fromFsPath(contextualUri.fsPath)).getScriptRoot();
    ...
    App.prompt.error("Error opening setup: " + (e instanceof Error ? e.message : e));
  }
}
